...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#093524] text-white pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex space-x-4">
            <a href="#" className="w-10 h-10 rounded-full border border-white flex items-center justify-center hover:bg-white hover:text-[#093524] transition-colors">

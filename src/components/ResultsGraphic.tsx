...
export default function ResultsGraphic() {
  ...
  // Continuous automatic rotation every 3 seconds
  useEffect(() => {
    ...
    <div className="mx-auto max-w-2xl">
      ...
      <div className="rounded-[32px] bg-forest text-white p-8 sm:p-12 text-center shadow-2xl border border-white/10 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center">
          ...
          <div className="relative w-56 h-56 sm:w-64 sm:h-64 flex items-center justify-center my-2">
            <svg className="w-full h-full -rotate-90 transform" viewBox="0 0 100 100">
              ...
              <circle
                ...
                fill="transparent"
              />
              {/* 5 Continuous Auto-Rotating Donut Segments */}
                ...
                <circle
                  ...
                  className={`transition-all duration-700 ease-out cursor-pointer ${
                    activeMetric === idx
                      ...
                      : idx === 2
                        ? "stroke-white/40 stroke-[8px] opacity-70 hover:stroke-white/80"
                        : "stroke-mid stroke-[8px] opacity-70 hover:stroke-neon"
                  }`}
            ...
            {/* Center Focal Metric with smooth transition */}
            <div
              key={activeMetric}
              className="absolute inset-0 flex flex-col items-center justify-center text-center p-6 transition-all duration-500 animate-fade-in"
            >
          ...
          <div className="flex flex-wrap justify-center gap-2 mt-8 max-w-lg">
            {segments.map((seg, idx) => (
              <button
                ...
                type="button"
                onClick={() => setActiveMetric(idx)}
                className={`relative px-4 py-2 rounded-full text-xs font-semibold tracking-wide transition-all duration-300 overflow-hidden ${
                  activeMetric === idx
          ...
          <div className="mt-8 pt-6 border-t border-white/15 w-full min-h-[52px] flex items-center justify-center">

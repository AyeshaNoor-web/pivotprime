            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
                ...
                <div className="lg:col-span-7 flex flex-col">
                  ...
                  {/* Quote Container */}
                  <div className="rounded-2xl border border-neutral-200/80 bg-neutral-50/70 p-6 mt-auto">
                ...
                <div className="lg:col-span-5 bg-neutral-50/50 rounded-2xl p-6 md:p-8 border border-neutral-100">
